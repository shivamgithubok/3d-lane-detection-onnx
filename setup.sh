...
echo "========================================================"
echo "  1. Image GPU Test:  ./venv/bin/python3 scripts/infer_tensorrt.py"
echo "  2. Video GPU Stream: ./venv/bin/python3 scripts/infer_video_tensorrt.py data/images/example_2.mp4"
echo "  3. Engine Benchmark: trtexec --loadEngine=models/anchor3dlane_raw.engine --shapes=img:1x3x360x480,mask:1x1x360x480 --iterations=100"
echo "========================================================"
