...
echo "  1. PySide6 ADAS UI:   python scripts/run_pyside6_app.py"
echo "     (default video: testing_new_videos/GRMN6694_540_nohud.mp4)"
echo "  2. Other Garmin clips:"
echo "     python scripts/run_pyside6_app.py --video testing_new_videos/GRMN6695_540_nohud.mp4"
echo "     python scripts/run_pyside6_app.py --video testing_new_videos/GRMN6700_540_nohud.mp4"
echo "  3. Image GPU Test:    python scripts/infer_tensorrt.py"
